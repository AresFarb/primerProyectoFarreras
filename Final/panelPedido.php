...
<html>
    ...
    <body>
        ...
        if(isset($_POST["finalizarPedido"])){
            setcookie("ultimoPedido", serialize($_SESSION["compra"]), time() + 5*60);
            $arrayPedido = $_SESSION["compra"];
            session_unset(); 
            session_destroy();
            echo "Pagament aceptat";
            ...
            <div class="row">
                ...
                <div class="col-3 margenes-carrito1">
                    ...
                    <div class="resumen">
                     ...
                     <div class="boto-final-pagar-pos">
                        <form action="panelPedido.php" method="post" class="float-end">
                            <input type="hidden" class="" name="finalizarPedido" value=""</input> 
                            <button type="submit" name="finalizarPedido" class="btn float-start boton-principal-inv">Pagar</button></td>
                        </form>
                     </div>
                     </div>
                </div>
