...
<body>
    ...
    <section class="container mt-5 pb-5 mb-5">
        ...
        <div class="product-pa-pag float-start">
            <img class="fotocolumna" src="<?= $bo->getImagen() ?>" alt="">
            ...
            <div class="btn float-start boton-principal falso-boton-principal margen-boton"><?=$bo->getPrecio()."€";?></div>
            <form action="comprapa.php" method="post">
                <input name="bo" value="<?= $i ?>" hidden>
